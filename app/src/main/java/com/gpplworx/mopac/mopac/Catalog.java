...
public class Catalog extends SQLiteOpenHelper{
    ...
    public void addBook(Book book){
        ...
        values.put(COLUMN_BOOK_DISTRIBUTION,book.get_distribution());
    ...
    public ArrayList<SearchResults> search(String search, String category){
        ...
        if(category.equals("title")){
            bquery = "SELECT * FROM " + TABLE_BOOK + " WHERE MATCH(title) AGAINST ('" + search +"' IN BOOLEAN MODE)";
            jquery = "SELECT * FROM " + TABLE_JOURNAL + " WHERE MATCH(article_title) AGAINST ('" + search +"' IN BOOLEAN MODE)";
        }else if(category.equals("author")){
            bquery = "SELECT * FROM " + TABLE_BOOK + " WHERE MATCH(author) AGAINST ('" + search +"' IN BOOLEAN MODE)";
            jquery = "SELECT * FROM " + TABLE_JOURNAL + " WHERE MATCH(author) AGAINST ('" + search +"' IN BOOLEAN MODE)";
        }else if(category.equals("subject")){
            bquery = "SELECT * FROM " + TABLE_BOOK + " WHERE MATCH(subject) AGAINST ('" + search +"' IN BOOLEAN MODE)";
            jquery = "SELECT * FROM " + TABLE_JOURNAL + " WHERE MATCH(subject) AGAINST ('" + search +"' IN BOOLEAN MODE)";
        }else if(category.equals("call number")){
            bquery = "SELECT * FROM " + TABLE_BOOK + " WHERE MATCH(call_number) AGAINST ('" + search +"' IN BOOLEAN MODE)";
        }
        ...
        if(!category.equals("call number")) {
            Cursor j = db.rawQuery(jquery, null);
